    ...
    <div>
      <Container>
        <Wrapper>
          ...
          <Login to="/register">Don't Have an account? Register!</Login>
          <Login to="/">Forgot Password?</Login>
        </Wrapper>
      </Container>
    </div>
  );
...
const Container = styled.div`
  ...
  background-size: 15%;
  background-position: left -1% top -15%, right -7.5% top -6%,
    right -5% bottom -5%, left -8% bottom -5%;
`;
