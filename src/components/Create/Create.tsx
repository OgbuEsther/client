...
const Create = () => {
    const schema = yup.object({
        ...
        number: yup.number().min(11).required("field must be required"),
  ...
  return (
    <Container>
        ...
        <Card onSubmit={Submit}>
            <Top><h1>Create a Secure Account</h1></Top>
            <P><p>Welcome to the future of Savings & Investments</p></P>
            <Inputhold>
            ...
            <Input {...register("number")} placeholder="Phone Number" type="number"/>
